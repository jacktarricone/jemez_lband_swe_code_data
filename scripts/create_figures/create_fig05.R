# figure 5 
# time series of snow depth, temp, wind speed, isolation during the study period
# jack tarricone

# 6 of noah's czo snow depth sensors on redondo
# WRCC station: valle grande and redondo peak
...
dat <-read_xlsx("./in_situ/snow_depth_sensors_nms_wy2020_level0-1.xlsx")
...
######## read in HQ met data
vg_met_data <-read.csv("./in_situ/vg_met_data_qaqc.csv")
...
redondo_met_data <-read.csv("./in_situ/redondo_met_data_qaqc.csv")
