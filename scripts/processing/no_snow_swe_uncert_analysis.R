# calculate statistics for no snow pixels as part of the uncertanity analyis 
# jack tarricone
# january 10th, 2023
...
p1 <-rast("./rasters/no_snow_uncert/p1_dswe_no_mask.tif")
p2 <-rast("./rasters/no_snow_uncert/p2_dswe_no_mask.tif")
p3 <-rast("./rasters/no_snow_uncert/p3_dswe_no_mask.tif")
